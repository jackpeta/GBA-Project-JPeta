...
// custom colors for my purposes - using ms paint to colormatch, super useful for transposing color
#define COLOR_8BIT(r, g, b) COLOR((r)*31/255, (g)*31/255, (b)*31/255)
#define MINESWEEPER_GREEN COLOR_8BIT(34, 177, 76)
...
#define FRONT_BUFFER ((volatile u16*)0x6000000)

extern u16 BACK_BUFFER[240 * 160] __attribute__((section(".ewram")));
